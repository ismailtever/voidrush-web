          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><Link to="/terms" className="hover:text-neon-blue transition-colors">Terms of Use</Link></li>
                <li><Link to="/privacy" className="hover:text-neon-blue transition-colors">Cookie Policy</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><Link to="/support" className="hover:text-neon-blue transition-colors">Help Center</Link></li>
                <li><Link to="/support" className="hover:text-neon-blue transition-colors">Contact Us</Link></li>
                <li><Link to="/support" className="hover:text-neon-blue transition-colors">FAQ</Link></li>
              </ul>
            </div>
